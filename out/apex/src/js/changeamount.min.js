...
const changeInputAmount = function(button, mode2) {
  ...
  if (amountWrapper) {
    ...
    mode2 === "sub" ? amountInput.value = Math.max(0, parseInt(amountInput.value, 10) - 1) : null;
    mode2 === "add" ? amountInput.value = parseInt(amountInput.value, 10) + 1 : null;
...
const debounceCall = /* @__PURE__ */ function() {
  let timer = 0;
